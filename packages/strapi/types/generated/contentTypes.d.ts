...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blocks: Attribute.DynamicZone<["shared.media", "shared.rich-text", "shared.embedded-media", "shared.media-gallery"]>
    ...
    listed: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
export interface ApiArticleLikesArticleLikes extends Schema.CollectionType {
  collectionName: "articles_likes"
  info: {
    singularName: "article-likes"
    pluralName: "articles-likes"
  ...
  attributes: {
    ...
    article: Attribute.Relation<"api::article-likes.article-likes", "oneToOne", "api::article.article">
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<"api::article-likes.article-likes", "oneToOne", "admin::user"> & Attribute.Private
    updatedBy: Attribute.Relation<"api::article-likes.article-likes", "oneToOne", "admin::user"> & Attribute.Private
  }
}
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    socialMedia: Attribute.Component<"social-media.social-media-account", true>
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    blocks: Attribute.DynamicZone<["shared.embedded-media", "shared.media-gallery", "shared.media", "shared.rich-text"]>
...
export interface ApiLiveLocationLiveLocation extends Schema.CollectionType {
  ...
  attributes: {
    location: Attribute.Component<"shared.location"> & Attribute.Required
    timestamp: Attribute.DateTime & Attribute.Required & Attribute.Unique
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<"api::live-location.live-location", "oneToOne", "admin::user"> & Attribute.Private
    updatedBy: Attribute.Relation<"api::live-location.live-location", "oneToOne", "admin::user"> & Attribute.Private
  }
}
...
declare module "@strapi/types" {
  export module Shared {
    export interface ContentTypes {
      ...
      "api::article-likes.article-likes": ApiArticleLikesArticleLikes
