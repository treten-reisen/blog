...
export type StrapiArticleListResponse = z.infer<
  typeof strapiArticleListResponseSchema
>
...
export const getArticleList = async () => {
  const response = await fetch(
    `${import.meta.env.STRAPI_API_URL}/api/articles?populate[image]=%2A`,
    {
